...
import './headerFlow1Fixed.css';


class HeaderFlow1Fixed extends React.Component {
    render() {
        return(
            <div className="fixed-flow1">
                <div className="header-flow1-fixed">
                    <div className="header-flow1-fixed__name">
                        <div className="header-flow1-fixed__name-id">#4859340543695496594</div>
                        <div className="header-flow1-fixed__name-dot"></div>
                        <div className="header-flow1-fixed__name-compname">Cty TNHH MTV Mặt trời đỏ</div>
                        {/* <div className="header-flow1-fixed__name-info">
                        </div> */}
                        {/* <Link to="#" className="header-flow1-fixed__action">
                        </Link>
                        <Link to="#" className="header-flow1-fixed__action">
                        </Link> */}
                        <div className="header-flow1-fixed__action-btn header-flow1-fixed__action-btn--active">
                            Chưa duyệt
                        </div>
                        <div className="header-flow1-fixed__action-btn">
                            Chờ duyệt
                        </div>
                    </div>
                    <div className="header-flow1-fixed__button">
                        <div className="header-flow1-fixed__button-print">
                            <svg className="header-flow1-fixed__button-size" xmlns="http://www.w3.org/2000/svg" id="Group_15031" data-name="Group 15031" width="21.334" height="21.333" viewBox="0 0 21.334 21.333">
                        ...
                        <div className="header-flow1-fixed__button-setting">

                            <input type="checkbox" name="" class="check-input-setting-fixed" id="input-setting-fixed"></input>

                            <label for="input-setting-fixed" className="header-flow1-fixed__button-click">
                                <svg className="header-flow1-fixed__button-size1" xmlns="http://www.w3.org/2000/svg" width="15.857" height="16" viewBox="0 0 15.857 16">
                            ...
                            <label for="input-setting-fixed" className="full-screen-setting-fixed"></label>

                            <div className="setting-list-fixed">
                                <div className="setting-list-fixed__update">
                                    <h5>Cập nhập trạng thái</h5>
                                </div>
                                <div className="setting-list-fixed__name">
                                    <h5>Lorem ipsum</h5>
                                </div>
                                <div className="setting-list-fixed__reward">
                                    <h5>Ghi nhận công nợ</h5>
                                    <h5>Thanh toán</h5>
                                    <h5>Phát tiền thưởng</h5>
                                </div>
                                <div className="setting-list-fixed__collect">
                                    <h5>Bỏ ghi công nợ</h5>
                                    <h5>Nhập lại kho</h5>
                                    <h5>Bỏ ghi thanh toán</h5>
                                    <h5>Thu hồi tiền thưởng</h5>
                                </div>
                                <div className="setting-list-fixed__del">
                                    <h5>Huỷ đơn</h5>
                                </div>
                            </div>
                        </div>
                        <Link to='/'>
                            <button className="header-flow1-fixed__button-done"> Duyệt đơn </button>
                        </Link>
                    </div>
                </div>
            </div>
...
export default HeaderFlow1Fixed;